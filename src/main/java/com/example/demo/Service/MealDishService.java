...
public class MealDishService {
        ...
        public List<Dish> getDefaultDishes() {
                ...
                dishes.add(defaultDish("Shirguruch", VoteCategory.BREAKFAST.name(),
                                "https://example.com/shirguruch.jpg",
                ...
                dishes.add(defaultDish("Qovurilgan tuxum", VoteCategory.BREAKFAST.name(),
                                "https://example.com/tuxum.jpg",
