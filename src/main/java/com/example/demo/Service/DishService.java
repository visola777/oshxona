...
public class DishService {
    ...
    public List<Dish> getDefaultDishes() {
        ...
        dishes.add(createDish("Shirguruch", VoteCategory.BREAKFAST.name(), "https://example.com/shirguruch.jpg",
                "Creamy rice with milk, honey and dried fruit."));
        dishes.add(createDish("Mannaya kasha", VoteCategory.BREAKFAST.name(), "https://example.com/kasha.jpg",
                "Warm semolina porridge with butter and jam."));
        dishes.add(createDish("Qovurilgan tuxum", VoteCategory.BREAKFAST.name(), "https://example.com/tuxum.jpg",
                "Golden fried eggs served with fresh herbs."));
        dishes.add(createDish("Lag'mon", VoteCategory.LUNCH.name(), "https://example.com/lagmon.jpg",
                "Hand-pulled noodle soup with beef and vegetables."));
        dishes.add(createDish("Mastava", VoteCategory.LUNCH.name(), "https://example.com/mastava.jpg",
                "Hearty rice soup with lamb and fresh greens."));
        dishes.add(createDish("Chuchvara", VoteCategory.LUNCH.name(), "https://example.com/chuchvara.jpg",
                "Savory dumplings in rich broth."));
        dishes.add(createDish("Somsa kartoshkali", VoteCategory.SNACK.name(), "https://example.com/somsa.jpg",
                "Crispy pastry filled with spiced potato."));
        dishes.add(createDish("Pitsa", VoteCategory.SNACK.name(), "https://example.com/pitsa.jpg",
                "Mini pizza slices perfect for a quick snack."));
        dishes.add(createDish("Sinabon", VoteCategory.SNACK.name(), "https://example.com/sinabon.jpg",
